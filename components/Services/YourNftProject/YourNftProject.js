  ...
  return (
    <>
      <div className="relative">
        <div className="flex justify-evenly items-center gap-[60px] mt-[60px] mb-[120px] max-sm:flex-col max-sm:gap-5 max-sm:my-0 sm:max-md:gap-0">
          <div className="absolute right-0 top-[150px] w-[182px] max-w-full h-[133.35px] bg-[#1caf83] opacity-40 blur-[100px] z-1"></div>
          <div>
            <img
              src="images/Service Page/Get-consultation-gif.gif"
              alt=""
              className="max-sm:w-20"
            />
          </div>
          <div>
            <h1 className="font-teko font-normal text-[56px] leading-[60px] text-[#222429] mb-5 max-sm:text-[32px] max-sm:leading-10 max-sm:mb-0 sm:max-md:text-[40px]">
              Have your NFT project done by Innowise Group
            </h1>
            <p className="font-rubik font-normal text-base leading-7 text-[#222429] mb-[25px]">
              Our world-class NFT developers will swiftly bring your project
              from the idea to a functional product
            </p>
            <button
