  ...
  return (
    <div className="bg-[#f1f1f1] py-[60px] px-0">
      ...
      <div className="container p-5">
        <div
          className="grid grid-cols-1 md:grid-cols-2 gap-10 py-[60px] px-0">
          <div>
            <img src={heroData.heroImage} alt="" className="w-full rounded-[10px]" />
          </div>
          <div>
            <h1 className="font-teko font-normal text-[32px] md:text-[64px] leading-[40px] md:leading-[63px] text-[#222429]">
              {heroData.title} <span className="font-teko font-normal text-[32px] md:text-[64px] leading-[40px] md:leading-[63px] text-[#1caf83]">{heroData.title2}</span>{" "}
            </h1>
