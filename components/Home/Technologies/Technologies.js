    ...
    <div className="container p-5">
      <div className="grid md:grid-cols-2 sm:grid-cols-1 gap-5 mb-10">
        <div className='flex flex-col justify-center'>
          <h1 className="font-teko font-normal text-[64px] leading-[63px] text-[#222429]">Technologies we work with</h1>
            ...
            techData.map((item) => {
              return (
                <div
                  ...
                  key={item.id}
                  className={`font-rubik font-normal text-lg leading-7 ${item.id === activeTech ? 'text-[#1caf83]' : 'text-[#7a7c7f]'} relative h-[37px] mb-5 cursor-pointer flex before:absolute before:bottom-0 before:content-[''] before:h-[2px] ${item.id === activeTech ? 'before:w-[80%] before:bg-[#1caf83] before:animate-slide' : 'before:w-[60px] before:bg-[#909194]'}`}
                >
                  <Image
                ...
                return (
                  <div key={idx} className={`flex mb-5`}>
                    ...
                    <div className="ml-3 flex-1">
                      <h1 className="font-teko font-normal text-[32px] leading-10 text-[#1caf83]">{item.title}</h1>
                      <p className="font-rubik font-normal text-lg leading-7 text-[#e9e9ea]">{item.description}</p>
                    </div>
                  </div>
                )
              })
