...
const RecentWorks = (props) => {
  ...
  const APEXDV = (
    <Icon sx={{ m: '1px' }}>
      <img alt="edit" src="/images/LandingPage/RecentWorks/apexdv.svg" style={{ margin: '1px', height: '24px', width: '24px' }} />
    </Icon>
  );
  const WEBSITE = (
    <Icon sx={{ m: '1px' }}>
      <img alt="edit" src="/images/LandingPage/RecentWorks/website.svg" style={{ margin: '1px', height: '24px', width: '24px' }} />
    </Icon>
  );
  const APP = (
    <Icon sx={{ m: '1px' }}>
      <img alt="edit" src="/images/LandingPage/RecentWorks/app.svg" style={{ margin: '1px', height: '24px', width: '24px' }} />
    </Icon>
  );
  const SOFTWARE = (
    <Icon sx={{ m: '1px' }}>
      <img alt="edit" src="/images/LandingPage/RecentWorks/software.svg" style={{ margin: '1px', height: '24px', width: '24px' }} />
    </Icon>
  );
  const APEXDVACTV = (
    <Icon sx={{ m: '1px' }}>
      <img alt="edit" src="/images/LandingPage/RecentWorks/apexdvactv.svg" style={{ margin: '1px', height: '24px', width: '24px' }} />
    </Icon>
  );
  const WEBSITEACTV = (
    <Icon sx={{ m: '1px' }}>
      <img alt="edit" src="/images/LandingPage/RecentWorks/websiteactv.svg" style={{ margin: '1px', height: '24px', width: '24px' }} />
    </Icon>
  );
  const APPACTV = (
    <Icon sx={{ m: '1px' }}>
      <img alt="edit" src="/images/LandingPage/RecentWorks/appactv.svg" style={{ margin: '1px', height: '24px', width: '24px' }} />
    </Icon>
  );
  const SOFTWAREACTV = (
    <Icon sx={{ m: '1px' }}>
      <img alt="edit" src="/images/LandingPage/RecentWorks/softwareactv.svg" style={{ margin: '1px', height: '24px', width: '24px' }} />
    </Icon>
  );

  const tabData = [[APEXDV,'All Works',APEXDVACTV],[WEBSITE,'Website',WEBSITEACTV],[APP,'Mobile App',APPACTV],[SOFTWARE,'Software Development',SOFTWAREACTV]]
  ...
  const handleAllWorks = (event,work) => {
    if (work === 'aota') { router.push('/portfolio-aota'); } 
    else if (work === 'coinzoom') { router.push('/portfolio-coinzoom');} 
    else if (work === 'cryptominium') { router.push('/portfolio-cryptominium');} 
    else if (work === 'enjin') { router.push('/portfolio-enjin');} 
    else if (work === 'galaxy') { router.push('/portfolio-galaxy');} 
    else if (work === 'homebase') { router.push('/portfolio-homebase');} 
    else if (work === 'horizen') { router.push('/portfolio-horizen');} 
    else if (work === 'impostors') { router.push('/portfolio-impostors');} 
    else if (work === 'luna') { router.push('/portfolio-luna');} 
    // else if (work === 'blocknative') { router.push('/portfolio-blocknative');} 
    else if (work === 'paraswap') { router.push('/portfolio-paraswap');} 
    else if (work === 'paritex') { router.push('/portfolio-paritex');} 
    else { router.push('/');}
  }
  ...
  return (
    <div>
      <Stack sx={{ justifyContent: 'space-around', alignItems: 'center', p: '50px 100px 50px 100px' }}>
        <Stack>
        <Typography sx={{ p: '30px', fontFamily: 'Teko', fontWeight: '400', fontSize:{xs:'32px',md:'64px'}, lineHeight:{xs:'40px',md:'64px'} }} variant='h2' component='h2'>Recent Works</Typography>
        </Stack>
        ...
        <div className="row">
          <div id='imgWrappper' className={styles.imageWrapper}>
            {active === 'All Works' ? (allWorks.map(work => (
              ...
              <Image
                src={`/images/LandingPage/RecentWorks/portfolios/${work}.png`}
                alt={work}
                width={500}
                height={400}
              />
            ...
            {active === 'Website' ? (website.map(web => (
              ...
              <Image
                src={`/images/LandingPage/RecentWorks/portfolios/${web}.png`}
                alt={web}
                width={500}
                height={400}
              />
            ...
            {active === 'Mobile App' ? (apps.map(app => (
              ...
              <Image
                src={`/images/LandingPage/RecentWorks/portfolios/${app}.png`}
                alt={app}
                width={500}
                height={400}
              />
            ...
            {active === 'Software Development' ? (softwares.map(software => (
              ...
              <Image
                src={`/images/LandingPage/RecentWorks/portfolios/${software}.png`}
                alt={software}
                width={500}
                height={400}
              />
