  ...
  return (
    <div className="py-[60px] bg-[#FAFAFA]">
      <div className="container mx-auto px-5">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:flex-col-reverse">
          <div className="text-center md:text-center">
            <div className="flex items-center justify-center md:justify-center max-md:hidden">
              ...
              />
              <button className="w-[123px] block py-3 px-2.5 gap-2.5 bg-[#1caf83] border border-[#1caf83] text-white transition-all duration-[0.4s] linear rounded-[35px] -ml-[50px] hover:bg-[#FAFAFA] hover:text-[#1caf83]">Search</button>
            </div>

            <h3 className="text-[32px] font-teko leading-10 font-normal text-[#383A3E] mt-[30px]">{title}</h3>
            <div className="grid grid-cols-2 gap-2.5 w-[280px] mt-5 mx-auto max-[320px]:grid-cols-1">
              <div className="w-[140px] p-2.5 bg-[#222429] rounded-[30px] mx-auto">
                <h2 className="font-rubik text-base font-normal text-left text-white">
                  {tag1} <span className="inline-block w-[26px] h-[26px] rounded-[40px] px-2.5 py-2.5 bg-[#2D2F34] text-center">85</span>
                </h2>
              </div>

              <div className="w-[164px] p-2.5 bg-[#222429] rounded-[30px] mx-auto">
                <h2 className="font-rubik text-base font-normal text-left text-white">
                  {tag2} <span className="inline-block w-[26px] h-[26px] rounded-[40px] px-2.5 py-2.5 bg-[#2D2F34] text-center">50</span>
                </h2>
              </div>

              <div className="w-[120px] p-2.5 bg-[#222429] rounded-[30px] mx-auto">
                <h2 className="font-rubik text-base font-normal text-left text-white">
                  {tag3} <span className="inline-block w-[26px] h-[26px] rounded-[40px] px-2.5 py-2.5 bg-[#2D2F34] text-center">55</span>
                </h2>
              </div>

              <div className="w-[132px] p-2.5 bg-[#222429] rounded-[30px] mx-auto">
                <h2 className="font-rubik text-base font-normal text-left text-white">
                  {tag4} <span className="inline-block w-[26px] h-[26px] rounded-[40px] px-2.5 py-2.5 bg-[#2D2F34] text-center">25</span>
                </h2>
              </div>
              <div className="w-[120px] p-2.5 bg-[#222429] rounded-[30px] mx-auto">
                <h2 className="font-rubik text-base font-normal text-left text-white">
                  {tag5} <span className="inline-block w-[26px] h-[26px] rounded-[40px] px-2.5 py-2.5 bg-[#2D2F34] text-center">45</span>
                </h2>
              </div>
              <div className="w-[124px] p-2.5 bg-[#222429] rounded-[30px] mx-auto">
                <h2 className="font-rubik text-base font-normal text-left text-white">
                  {tag6} <span className="inline-block w-[26px] h-[26px] rounded-[40px] px-2.5 py-2.5 bg-[#2D2F34] text-center">75</span>
                </h2>
              </div>
            </div>

            <h3 className="text-[32px] font-teko leading-10 font-normal text-[#383A3E] mt-[30px]">{title2}</h3>
            ...
            <h3 className="text-[32px] font-teko leading-10 font-normal text-[#383A3E] mt-[30px]">{title3}</h3>
            <div>
              <input
                placeholder="e.g design"
                type="email"
              ...
              />
              <button className="w-[222px] block py-3 px-2.5 gap-2.5 bg-[#1caf83] border border-[#1caf83] text-white font-rubik text-base font-normal leading-7 transition-all duration-[0.4s] linear rounded-[35px] mt-5 mx-auto mb-[30px] md:w-full hover:bg-[#FAFAFA] hover:text-[#1caf83]">Search</button>
            </div>
          </div>
