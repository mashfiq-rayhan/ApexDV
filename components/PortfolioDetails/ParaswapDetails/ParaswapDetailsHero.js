    ...
    <div className={styles.heroSection}>
      <div className="container mx-auto px-5">
        ...
        <div className={styles.paraSwapMobile}>
          ...
          <p>{heroData.text2}</p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 paraSwapMobileMobile">
            <div className={styles.paraSwapMobileText}>
              <h3>{heroData.title3}</h3>
              <p>{heroData.bodyText1}</p>
              <p>{heroData.bodyText2}</p>
              <p>{heroData.bodyText3}</p>
            </div>
            <div className={styles.paraSwapMobileImage}>
