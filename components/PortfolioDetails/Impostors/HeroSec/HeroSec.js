...
const HeroSec = () => {
  return (
    ...
    <div className="flex flex-col lg:flex-row justify-evenly" style={{backgroundColor:'#904F3D'}}>
        <div className="hidden lg:block">
            <div className={styles.quote}>Get a free quote</div>
        </div>
        <div className="h-full">
            <img className="h-full m-0 lg:my-42" alt="Hero" src={`/images/Portfolio Details impostors/HeroImg.svg`} />
        </div>
        <div className="mx-1.5 my-5 lg:my-50.5 lg:mr-50 lg:ml-0">
            <img className="h-14 w-50.75" alt="Aota" src={`/images/Portfolio Details impostors/impostors.svg`} />
