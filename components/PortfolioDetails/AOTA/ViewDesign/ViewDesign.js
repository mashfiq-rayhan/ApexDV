...
const ViewDesign = () => {
  return (
    <Stack sx={{ justifyContent: 'space-around', flexDirection: { xs: 'column', lg: 'row' } }}>
      ...
      <Stack sx={{ height: '100%' }}>
        <Box sx={{ height: { xs: '100%', lg: '736px' }, ml: { xs: '0', lg: '100px' }, p: '40px' }} component="img" alt="Hero" src={`/images/Portfolio Details AOTA/AotaWeb.svg`} />
      </Stack>
      <Stack sx={{ m: { xs: '10px 5px', lg: '202px 150px' } }}>
        <Typography sx={{ fontFamily: 'Teko', fontWeight: '400' }} variant='h2' component='h2'>AOTA Responsive Design</Typography>
