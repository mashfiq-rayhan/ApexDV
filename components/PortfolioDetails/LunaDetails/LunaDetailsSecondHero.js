...
const LunaDetailsSecondHero = () => {
  const heroData = {
    ...
    text: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Libero odio egestas id id arcu, hac augue.",
  ...
  return (
    <div className={styles.lunaDetailsHero}>
      ...
      <div className="container">
        <div
          className={`grid grid-cols-1 md:grid-cols-2 gap-4 ${styles.lunaDetailsSecondHeroContainer}`}>
