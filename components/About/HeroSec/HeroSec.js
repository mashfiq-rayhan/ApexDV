    ...
    return (
        <>
            ...
            <div className="relative">
                <div className="absolute left-[0.14%] top-[140px] bg-[#1caf83] opacity-35 lg:opacity-20 blur-[90px] w-[182px] max-w-full h-[133.35px] z-[1]"></div>
                <div className="absolute right-[0.62%] top-[140px] bg-[#1caf83] opacity-35 lg:opacity-20 blur-[100px] w-[182px] max-w-full h-[133.35px] z-[1]"></div>
                <div className='container mx-auto p-5'>
                
                <div className="columns-1">
                    <div>
                        
                        <h1 className="font-teko font-normal text-[64px] leading-[63px] text-[#222429] mb-5">How it all began
